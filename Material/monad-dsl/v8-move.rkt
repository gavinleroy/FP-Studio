...
;; Try out the generic form with a more efficient monad
;; implementation. Instead of appending lists, accumulate
;; a list with `cons` and then reverse it.

;; (My full Santorini implementation uses this representation,
;;  but hardwired into `comprehension.)
